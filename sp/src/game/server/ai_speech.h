...
public:
...
#ifdef MAPBASE
	bool Speak( AIConcept_t aiConcept, const AI_CriteriaSet& modifiers, char *pszOutResponseChosen = NULL, size_t bufsize = 0, IRecipientFilter *filter = NULL );
...
#ifdef MAPBASE
	bool SpeakDispatchResponse( AIConcept_t aiConcept, AI_Response *response, IRecipientFilter *filter = NULL, const AI_CriteriaSet *modifiers = NULL );
#else
	bool SpeakDispatchResponse( AIConcept_t aiConcept, AI_Response *response, IRecipientFilter *filter = NULL );
#endif
	...
	bool CanSpeakConcept( AIConcept_t aiConcept );
	bool SpokeConcept( AIConcept_t aiConcept );
	float GetTimeSpokeConcept( AIConcept_t aiConcept ); // returns -1 if never
	void SetSpokeConcept( AIConcept_t aiConcept, AI_Response *response, bool bCallback = true );
	void ClearSpokeConcept( AIConcept_t aiConcept );
...
public:
...
#ifdef MAPBASE
	virtual bool 	Speak( AIConcept_t aiConcept, const AI_CriteriaSet& modifiers, char *pszOutResponseChosen = NULL, size_t bufsize = 0, IRecipientFilter *filter = NULL );
#endif
	...
	AI_Response *	SpeakFindResponse( AIConcept_t aiConcept, const AI_CriteriaSet& modifiers );
#endif
	bool 			SpeakDispatchResponse( AIConcept_t aiConcept, AI_Response *response );
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline bool CAI_ExpresserHost<BASE_NPC>::Speak( AIConcept_t aiConcept, const AI_CriteriaSet& modifiers, char *pszOutResponseChosen /*=NULL*/, size_t bufsize /* = 0 */, IRecipientFilter *filter /* = NULL */ ) 
{
	AssertOnce( this->GetExpresser()->GetOuter() == this );
	return this->GetExpresser()->Speak( aiConcept, modifiers, pszOutResponseChosen, bufsize, filter ); 
}
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline AI_Response *CAI_ExpresserHost<BASE_NPC>::SpeakFindResponse( AIConcept_t aiConcept, const char *modifiers /*= NULL*/ )
{
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline AI_Response *CAI_ExpresserHost<BASE_NPC>::SpeakFindResponse( AIConcept_t aiConcept, const AI_CriteriaSet& modifiers )
{
	return this->GetExpresser()->SpeakFindResponse( aiConcept, modifiers );
}
#endif
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline bool CAI_ExpresserHost<BASE_NPC>::SpeakDispatchResponse( AIConcept_t aiConcept, AI_Response *response )
{
	if ( this->GetExpresser()->SpeakDispatchResponse( aiConcept, response ) )
	{
